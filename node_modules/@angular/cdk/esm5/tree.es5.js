...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkTreeNode, [{
    ...
    }], function () { return [{ type: ElementRef }, { type: CdkTree }]; }, { _elementRef: [], _tree: [], _destroyed: [], role: [{
            type: Input
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkNestedTreeNode, [{
    ...
    }], function () { return [{ type: ElementRef }, { type: CdkTree }, { type: IterableDiffers }]; }, { ngAfterContentInit: [], _dataDiffer: [], ngOnDestroy: [], updateChildrenNodes: [], _children: [], _clear: [], nodeOutlet: [{
            type: ContentChildren,
            args: [CdkTreeNodeOutlet]
        }] });
