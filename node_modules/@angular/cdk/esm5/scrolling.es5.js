...
CdkScrollable.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: CdkScrollable, selectors: [["", "cdk-scrollable", ""], ["", "cdkScrollable", ""]], factory: function CdkScrollable_Factory(t) { return new (t || CdkScrollable)(ɵngcc0.ɵɵdirectiveInject(ElementRef), ɵngcc0.ɵɵdirectiveInject(ScrollDispatcher), ɵngcc0.ɵɵdirectiveInject(NgZone)); } });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkScrollable, [{
        type: Directive,
        args: [{
                selector: '[cdk-scrollable], [cdkScrollable]'
            }]
    }], function () { return [{ type: ElementRef }, { type: ScrollDispatcher }, { type: NgZone }]; }, { _elementRef: [], _scroll: [], _ngZone: [], _elementScrolled: [], _scrollListener: [], ngOnInit: [], ngOnDestroy: [], elementScrolled: [], getElementRef: [] });
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ViewportRuler, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: Platform }, { type: NgZone }]; }, { _platform: [], _change: [], _invalidateCache: [], ngOnDestroy: [], getViewportSize: [], _viewportSize: [], getViewportRect: [], getViewportScrollPosition: [], change: [], _updateViewportSize: [] });
...
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(ScrollDispatchModule, { declarations: function () { return [CdkScrollable]; }, imports: function () { return [PlatformModule]; }, exports: function () { return [CdkScrollable]; } });
...
ScrollDispatchModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function ScrollDispatchModule_Factory(t) { return new (t || ScrollDispatchModule)(); }, imports: [[PlatformModule]] });
