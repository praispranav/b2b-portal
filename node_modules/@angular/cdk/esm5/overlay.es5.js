...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(Overlay, [{
        type: Injectable
                ...
                type: Inject,
                args: [DOCUMENT]
            }] }, { type: Directionality }]; }, { scrollStrategies: [], _overlayContainer: [], _componentFactoryResolver: [], _positionBuilder: [], _keyboardDispatcher: [], _injector: [], _ngZone: [], _document: [], _directionality: [], create: [], position: [], _createPaneElement: [], _createHostElement: [], _createPortalOutlet: [], _appRef: [] });
    return Overlay;
}());
