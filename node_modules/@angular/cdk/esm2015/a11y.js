...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(AriaDescriber, [{
        ...
        args: [{ providedIn: 'root' }]
                ...
                type: Inject,
                args: [DOCUMENT]
            }] }]; }, { constructor: [], _document: [], describe: [], removeDescription: [], ngOnDestroy: [], _createMessageElement: [], _deleteMessageElement: [], _createMessagesContainer: [], _deleteMessagesContainer: [], _removeCdkDescribedByReferenceIds: [], _addMessageReference: [], _removeMessageReference: [], _isElementDescribedByMessage: [], _canBeDescribed: [] });
/** @nocollapse */
...
LiveAnnouncer.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: LiveAnnouncer, factory: function LiveAnnouncer_Factory(t) { return new (t || LiveAnnouncer)(ɵngcc0.ɵɵinject(LIVE_ANNOUNCER_ELEMENT_TOKEN, 8), ɵngcc0.ɵɵinject(DOCUMENT)); }, providedIn: 'root' });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(LiveAnnouncer, [{
        ...
        args: [{ providedIn: 'root' }]
                ...
                type: Inject,
                args: [DOCUMENT]
            }] }]; }, { constructor: [], _document: [], _liveElement: [], announce: [], ngOnDestroy: [], _createLiveElement: [] });
/** @nocollapse */
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkAriaLive, [{
        ...
        args: [{
            ...
            type: Input,
            args: ['cdkAriaLive']
        }], politeness: [], _subscription: [], ngOnDestroy: [] });
/** @nocollapse */
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(FocusMonitor, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: NgZone }, { type: Platform }]; }, { constructor: [], _ngZone: [], _platform: [], _origin: [], _windowFocused: [], _elementInfo: [], _unregisterGlobalListeners: [], _monitoredElementCount: [], monitor: [], stopMonitoring: [], focusVia: [], ngOnDestroy: [], _registerGlobalListeners: [], _lastTouchTarget: [], _touchTimeoutId: [], _windowFocusTimeoutId: [], _toggleClass: [], _setClasses: [], _setOriginForCurrentEventQueue: [], _originTimeoutId: [], _wasCausedByTouch: [], _onFocus: [], _lastFocusOrigin: [], _onBlur: [], _emitOrigin: [], _incrementMonitoredElementCount: [], _decrementMonitoredElementCount: [] });
/** @nocollapse */
