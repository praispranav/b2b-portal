...
CdkStep.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: CdkStep, selectors: [["cdk-step"]], factory: function CdkStep_Factory(t) { return new (t || CdkStep)(ɵngcc0.ɵɵdirectiveInject(forwardRef(() => CdkStepper))); }, contentQueries: function CdkStep_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkStep, [{
        ...
        args: [{ selector: 'cdk-step',
            ...
            }] }]; }, { constructor: [], _stepper: [], interacted: [], _editable: [], _optional: [], _customCompleted: [], editable: [{
            type: Input
        }], editable: [], optional: [{
            type: Input
        }], optional: [], completed: [{
