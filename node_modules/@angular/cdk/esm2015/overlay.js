...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(OverlayPositionBuilder, [{
        ...
        args: [{ providedIn: 'root' }]
                ...
                type: Optional
            }] }]; }, { constructor: [], _viewportRuler: [], _document: [], _platform: [], _overlayContainer: [], global: [], connectedTo: [], flexibleConnectedTo: [] });
/** @nocollapse */
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(Overlay, [{
        type: Injectable
                ...
                type: Inject,
                args: [DOCUMENT]
            }] }, { type: Directionality }]; }, { constructor: [], scrollStrategies: [], _overlayContainer: [], _componentFactoryResolver: [], _positionBuilder: [], _keyboardDispatcher: [], _injector: [], _ngZone: [], _document: [], _directionality: [], create: [], position: [], _createPaneElement: [], _createHostElement: [], _createPortalOutlet: [], _appRef: [] });
/** @nocollapse */
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkConnectedOverlay, [{
        ...
        args: [{
                ...
                type: Optional
            }] }]; }, { constructor: [], _overlay: [], _scrollStrategy: [], _dir: [], _hasBackdrop: [], _lockPosition: [], _growAfterOpen: [], _flexibleDimensions: [], _push: [], _backdropSubscription: [], viewportMargin: [{
            type: Input,
...
FullscreenOverlayContainer.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: FullscreenOverlayContainer, factory: function FullscreenOverlayContainer_Factory(t) { return new (t || FullscreenOverlayContainer)(ɵngcc0.ɵɵinject(DOCUMENT)); }, providedIn: null });
