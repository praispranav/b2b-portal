...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MediaMatcher, [{
    ...
    }], function () { return [{ type: Platform }]; }, { constructor: [], platform: [], _matchMedia: [], matchMedia: [] });
/** @nocollapse */
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(BreakpointObserver, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: MediaMatcher }, { type: NgZone }]; }, { constructor: [], mediaMatcher: [], zone: [], _queries: [], _destroySubject: [], ngOnDestroy: [], isMatched: [], observe: [], _registerQuery: [] });
/** @nocollapse */
