...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(MediaMatcher, [{
    ...
    }], function () { return [{ type: platform.Platform }]; }, { platform: [], _matchMedia: [], matchMedia: [] });
    return MediaMatcher;
}());
/**
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(BreakpointObserver, [{
        type: core.Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: MediaMatcher }, { type: core.NgZone }]; }, { mediaMatcher: [], zone: [], _queries: [], _destroySubject: [], ngOnDestroy: [], isMatched: [], observe: [], _registerQuery: [] });
