...
CdkTreeNodeOutlet.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: CdkTreeNodeOutlet, selectors: [["", "cdkTreeNodeOutlet", ""]], factory: function CdkTreeNodeOutlet_Factory(t) { return new (t || CdkTreeNodeOutlet)(ɵngcc0.ɵɵdirectiveInject(core.ViewContainerRef)); } });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkTreeNodeOutlet, [{
        type: core.Directive,
        args: [{
                selector: '[cdkTreeNodeOutlet]'
            }]
    }], function () { return [{ type: core.ViewContainerRef }]; }, { viewContainer: [] });
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkTreeNode, [{
    ...
    }], function () { return [{ type: core.ElementRef }, { type: CdkTree }]; }, { _elementRef: [], _tree: [], _destroyed: [], role: [{
            type: core.Input
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkNestedTreeNode, [{
    ...
    }], function () { return [{ type: core.ElementRef }, { type: CdkTree }, { type: core.IterableDiffers }]; }, { ngAfterContentInit: [], _dataDiffer: [], ngOnDestroy: [], updateChildrenNodes: [], _children: [], _clear: [], nodeOutlet: [{
            type: core.ContentChildren,
            args: [CdkTreeNodeOutlet]
        }] });
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkTreeNodePadding, [{
        ...
        args: [{
                ...
                type: core.Optional
            }] }]; }, { _treeNode: [], _tree: [], _renderer: [], _element: [], _dir: [], _destroyed: [], _indent: [], level: [{
            type: core.Input,
            args: ['cdkTreeNodePadding']
        }], level: [], indent: [{
            type: core.Input,
            args: ['cdkTreeNodePaddingIndent']
        }], indent: [], ngOnDestroy: [], _paddingIndent: [], _setPadding: [] });
