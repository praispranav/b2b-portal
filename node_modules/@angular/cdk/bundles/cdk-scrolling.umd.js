...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/platform'), require('@angular/core'), require('rxjs'), require('rxjs/operators'),require('@angular/core'),require('@angular/cdk/platform')) :
	typeof define === 'function' && define.amd ? define('@angular/cdk/scrolling', ['exports', '@angular/cdk/platform', '@angular/core', 'rxjs', 'rxjs/operators','@angular/core','@angular/cdk/platform'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.cdk = global.ng.cdk || {}, global.ng.cdk.scrolling = {}),global.ng.cdk.platform,global.ng.core,global.rxjs,global.rxjs.operators,global.ng.core,global.ng.cdk/platform));
}(this, (function (exports,platform,core,rxjs,operators,ɵngcc0,ɵngcc1) { 'use strict';
...
CdkScrollable.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: CdkScrollable, selectors: [["", "cdk-scrollable", ""], ["", "cdkScrollable", ""]], factory: function CdkScrollable_Factory(t) { return new (t || CdkScrollable)(ɵngcc0.ɵɵdirectiveInject(core.ElementRef), ɵngcc0.ɵɵdirectiveInject(ScrollDispatcher), ɵngcc0.ɵɵdirectiveInject(core.NgZone)); } });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkScrollable, [{
        type: core.Directive,
        args: [{
                selector: '[cdk-scrollable], [cdkScrollable]'
            }]
    }], function () { return [{ type: core.ElementRef }, { type: ScrollDispatcher }, { type: core.NgZone }]; }, { _elementRef: [], _scroll: [], _ngZone: [], _elementScrolled: [], _scrollListener: [], ngOnInit: [], ngOnDestroy: [], elementScrolled: [], getElementRef: [] });
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(ViewportRuler, [{
        type: core.Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: platform.Platform }, { type: core.NgZone }]; }, { _platform: [], _change: [], _invalidateCache: [], ngOnDestroy: [], getViewportSize: [], _viewportSize: [], getViewportRect: [], getViewportScrollPosition: [], change: [], _updateViewportSize: [] });
...
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(ScrollDispatchModule, { declarations: [CdkScrollable], imports: [ɵngcc1.PlatformModule], exports: [CdkScrollable] });
...
ScrollDispatchModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function ScrollDispatchModule_Factory(t) { return new (t || ScrollDispatchModule)(); }, imports: [[platform.PlatformModule]] });
