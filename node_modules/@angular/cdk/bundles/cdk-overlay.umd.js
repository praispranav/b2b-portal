...
(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define('@angular/cdk/overlay', ['exports', '@angular/core', '@angular/cdk/coercion', '@angular/cdk/scrolling', '@angular/common', 'rxjs', 'rxjs/operators', '@angular/cdk/platform', '@angular/cdk/bidi', '@angular/cdk/portal', '@angular/cdk/keycodes','@angular/core','@angular/cdk/bidi','@angular/cdk/portal','@angular/cdk/scrolling'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.cdk = global.ng.cdk || {}, global.ng.cdk.overlay = {}),global.ng.core,global.ng.cdk.coercion,global.ng.cdk.scrolling,global.ng.common,global.rxjs,global.rxjs.operators,global.ng.cdk.platform,global.ng.cdk.bidi,global.ng.cdk.portal,global.ng.cdk.keycodes,global.ng.core,global.ng.cdk/bidi,global.ng.cdk/portal,global.ng.cdk/scrolling));
}(this, (function (exports,core,coercion,scrolling,common,rxjs,operators,platform,bidi,portal,keycodes,ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3) { 'use strict';
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(OverlayPositionBuilder, [{
        ...
        args: [{ providedIn: 'root' }]
                ...
                type: core.Inject,
                args: [common.DOCUMENT]
            }] }, { type: platform.Platform, decorators: [{
                type: core.Optional
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(Overlay, [{
        type: core.Injectable
                ...
                type: core.Inject,
                args: [common.DOCUMENT]
            }] }, { type: bidi.Directionality }]; }, { scrollStrategies: [], _overlayContainer: [], _componentFactoryResolver: [], _positionBuilder: [], _keyboardDispatcher: [], _injector: [], _ngZone: [], _document: [], _directionality: [], create: [], position: [], _createPaneElement: [], _createHostElement: [], _createPortalOutlet: [], _appRef: [] });
    return Overlay;
}());
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CdkConnectedOverlay, [{
        ...
        args: [{
                ...
                type: core.Optional
            }] }]; }, { _overlay: [], _scrollStrategy: [], _dir: [], _hasBackdrop: [], _lockPosition: [], _growAfterOpen: [], _flexibleDimensions: [], _push: [], _backdropSubscription: [], viewportMargin: [{
            type: core.Input,
        ...
        }], lockPosition: [], flexibleDiemsions: [{
            type: core.Input,
            args: ['cdkConnectedOverlayFlexibleDimensions']
        }], flexibleDiemsions: [], growAfterOpen: [{
            type: core.Input,
        ...
        }], _overlayRef: [], _buildConfig: [], _position: [], _createPositionStrategy: [], _setPositions: [], _attachOverlay: [], _detachOverlay: [], _destroyOverlay: [], origin: [{
            type: core.Input,
...
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(OverlayModule, { declarations: [CdkConnectedOverlay,
        CdkOverlayOrigin], imports: [ɵngcc1.BidiModule, ɵngcc2.PortalModule, ɵngcc3.ScrollDispatchModule], exports: [CdkConnectedOverlay,
        CdkOverlayOrigin, ɵngcc3.ScrollDispatchModule] });
...
OverlayModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function OverlayModule_Factory(t) { return new (t || OverlayModule)(); }, providers: [
        Overlay,
        CDK_CONNECTED_OVERLAY_SCROLL_STRATEGY_PROVIDER,
    ], imports: [[bidi.BidiModule, portal.PortalModule, scrolling.ScrollDispatchModule], ɵngcc3.ScrollDispatchModule] });
...
FullscreenOverlayContainer.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: FullscreenOverlayContainer, factory: function FullscreenOverlayContainer_Factory(t) { return new (t || FullscreenOverlayContainer)(ɵngcc0.ɵɵinject(common.DOCUMENT)); }, providedIn: null });
