...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(AriaDescriber, [{
        ...
        args: [{ providedIn: 'root' }]
            ...
            }] }]; }, { _document: [], describe: [], removeDescription: [], ngOnDestroy: [], _createMessageElement: [], _deleteMessageElement: [], _createMessagesContainer: [], _deleteMessagesContainer: [], _removeCdkDescribedByReferenceIds: [], _addMessageReference: [], _removeMessageReference: [], _isElementDescribedByMessage: [], _canBeDescribed: [] });
...
LiveAnnouncer.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: LiveAnnouncer, factory: function LiveAnnouncer_Factory(t) { return new (t || LiveAnnouncer)(ɵngcc0.ɵɵinject(LIVE_ANNOUNCER_ELEMENT_TOKEN, 8), ɵngcc0.ɵɵinject(common.DOCUMENT)); }, providedIn: 'root' });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(LiveAnnouncer, [{
        ...
        args: [{ providedIn: 'root' }]
                ...
                type: core.Inject,
                args: [common.DOCUMENT]
            }] }]; }, { _document: [], _liveElement: [], announce: [], ngOnDestroy: [], _createLiveElement: [] });
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(FocusMonitor, [{
        type: core.Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: core.NgZone }, { type: platform.Platform }]; }, { _ngZone: [], _platform: [], _origin: [], _windowFocused: [], _elementInfo: [], _unregisterGlobalListeners: [], _monitoredElementCount: [], monitor: [], stopMonitoring: [], focusVia: [], ngOnDestroy: [], _registerGlobalListeners: [], _toggleClass: [], _setClasses: [], _setOriginForCurrentEventQueue: [], _wasCausedByTouch: [], _onFocus: [], _lastFocusOrigin: [], _onBlur: [], _emitOrigin: [], _incrementMonitoredElementCount: [], _decrementMonitoredElementCount: [] });
    return FocusMonitor;
}());
/**
