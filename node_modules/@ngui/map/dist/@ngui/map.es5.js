...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NguiMap, [{
        type: Injectable
    }], function () { return [{ type: GeoCoder }, { type: OptionBuilder }, { type: NgZone }]; }, { geoCoder: [], optionBuilder: [], zone: [], updateGoogleObject: [], setObjectEvents: [], clearObjectEvents: [], getEventName: [] });
    return NguiMap;
}());
/**
 * @nocollapse
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NguiMapComponent, [{
    ...
    }], function () { return [{ type: OptionBuilder }, { type: ElementRef }, { type: NavigatorGeolocation }, { type: GeoCoder }, { type: NguiMap }, { type: NgMapApiLoader }, { type: NgZone }]; }, { optionBuilder: [], elementRef: [], geolocation: [], geoCoder: [], nguiMap: [], apiLoader: [], zone: [], mapReady$: [{
            type: Output
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(InfoWindow, [{
    ...
    }], function () { return [{ type: ElementRef }, { type: NguiMap }, { type: NguiMapComponent }]; }, { elementRef: [], nguiMap: [], nguiMapComponent: [], initialized$: [{
            type: Output
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CustomMarker, [{
    ...
    }], function () { return [{ type: NguiMapComponent }, { type: ElementRef }, { type: NguiMap }]; }, { nguiMapComponent: [], elementRef: [], nguiMap: [], initialized$: [{
            type: Output
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(PlacesAutoComplete, [{
    ...
    }], function () { return [{ type: OptionBuilder }, { type: ElementRef }, { type: NgMapApiLoader }]; }, { optionBuilder: [], elementRef: [], apiLoader: [], place_changed: [{
            type: Output,
            args: ['place_changed']
        }], initialized$: [{
            type: Output
