(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/Observable'), require('rxjs/ReplaySubject'), require('rxjs/operator/first'), require('rxjs/Subject'), require('rxjs/operator/debounceTime'), require('@angular/common'),require('@angular/core'),require('@angular/common')) :
	...
	(factory((global.map = {}),global.ng.core,global.Rx,global.Rx,global.Rx.Observable.prototype,global.Rx,global.Rx.Observable.prototype,global.ng.common,global.ng.core,global.ng.common));
}(this, (function (exports,core,Observable,ReplaySubject,first,Subject,debounceTime,common,ɵngcc0,ɵngcc1) { 
const _c0 = [1, "google-map"];
const _c1 = ["*"];
const _c2 = ["template"];
const _c3 = ["template", ""];
'use strict';
...
BaseMapDirective.ngBaseDef = ɵngcc0.ɵɵdefineBase({ outputs: { initialized$: "initialized$" } });
...
OptionBuilder.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: OptionBuilder, factory: function OptionBuilder_Factory(t) { return new (t || OptionBuilder)(); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(OptionBuilder, [{
        type: core.Injectable
    }], function () { return []; }, { googlizeAllInputs: [], googlizeMultiple: [], googlize: [], getLatLng: [], getJSONParsed: [], getAnyMapObject: [], getAnyMapConstant: [], getMapControlOption: [], getDateObject: [], getMapIcons: [], getMarkerIcon: [], onlyOptionsGiven: [] });
...
NavigatorGeolocation.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: NavigatorGeolocation, factory: function NavigatorGeolocation_Factory(t) { return new (t || NavigatorGeolocation)(); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NavigatorGeolocation, [{
        type: core.Injectable
    }], function () { return []; }, { getCurrentPosition: [] });
...
NgMapAsyncCallbackApiLoader.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: NgMapAsyncCallbackApiLoader, factory: function NgMapAsyncCallbackApiLoader_Factory(t) { return new (t || NgMapAsyncCallbackApiLoader)(ɵngcc0.ɵɵinject(core.NgZone), ɵngcc0.ɵɵinject(NG_MAP_CONFIG_TOKEN, 8)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NgMapAsyncCallbackApiLoader, [{
        type: core.Injectable
...
NgMapAsyncApiLoader.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: NgMapAsyncApiLoader, factory: function NgMapAsyncApiLoader_Factory(t) { return new (t || NgMapAsyncApiLoader)(ɵngcc0.ɵɵinject(NG_MAP_CONFIG_TOKEN, 8)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NgMapAsyncApiLoader, [{
        type: core.Injectable
...
GeoCoder.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: GeoCoder, factory: function GeoCoder_Factory(t) { return new (t || GeoCoder)(ɵngcc0.ɵɵinject(NgMapApiLoader)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(GeoCoder, [{
        type: core.Injectable
    }], function () { return [{ type: NgMapApiLoader }]; }, { apiLoader: [], apiLoaderSubs: [], geocode: [], ngOnDestroy: [], requestGeocode: [] });
    return GeoCoder;
}());
/**
 * @nocollapse
...
NguiMap.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: NguiMap, factory: function NguiMap_Factory(t) { return new (t || NguiMap)(ɵngcc0.ɵɵinject(GeoCoder), ɵngcc0.ɵɵinject(OptionBuilder), ɵngcc0.ɵɵinject(core.NgZone)); }, providedIn: null });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NguiMap, [{
        type: core.Injectable
    }], function () { return [{ type: GeoCoder }, { type: OptionBuilder }, { type: core.NgZone }]; }, { geoCoder: [], optionBuilder: [], zone: [], updateGoogleObject: [], setObjectEvents: [], clearObjectEvents: [], getEventName: [] });
    return NguiMap;
}());
/**
 * @nocollapse
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NguiMapComponent, [{
    ...
    }], function () { return [{ type: OptionBuilder }, { type: core.ElementRef }, { type: NavigatorGeolocation }, { type: GeoCoder }, { type: NguiMap }, { type: NgMapApiLoader }, { type: core.NgZone }]; }, { optionBuilder: [], elementRef: [], geolocation: [], geoCoder: [], nguiMap: [], apiLoader: [], zone: [], mapReady$: [{
            type: core.Output
        }], mapOptions: [], inputChanges$: [], infoWindows: [], mapIdledOnce: [], initializeMapAfterDisplayed: [], ngAfterViewInit: [], apiLoaderSub: [], ngAfterViewChecked: [], ngOnChanges: [], initializeMap: [], el: [], setCenter: [], openInfoWindow: [], closeInfoWindow: [], ngOnDestroy: [], addToMapObjectGroup: [], removeFromMapObjectGroup: [] });
...
BicyclingLayer.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: BicyclingLayer, selectors: [["bicycling-layer"]], factory: function BicyclingLayer_Factory(t) { return new (t || BicyclingLayer)(ɵngcc0.ɵɵdirectiveInject(NguiMapComponent)); }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(BicyclingLayer, [{
        type: core.Directive,
        args: [{
...
InfoWindow.ngComponentDef = ɵngcc0.ɵɵdefineComponent({ type: InfoWindow, selectors: [["info-window"]], factory: function InfoWindow_Factory(t) { return new (t || InfoWindow)(ɵngcc0.ɵɵdirectiveInject(core.ElementRef), ɵngcc0.ɵɵdirectiveInject(NguiMap), ɵngcc0.ɵɵdirectiveInject(NguiMapComponent)); }, viewQuery: function InfoWindow_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(_c2, true, core.ViewContainerRef);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadViewQuery()) && (ctx.template = _t.first);
    } }, inputs: { content: "content", disableAutoPan: "disableAutoPan", maxWidth: "maxWidth", pixelOffset: "pixelOffset", position: "position", zIndex: "zIndex", options: "options" }, outputs: { closeclick: "closeclick", content_changed: "content_changed", domready: "domready", position_changed: "position_changed", zindex_changed: "zindex_changed", initialized$: "initialized$" }, features: [ɵngcc0.ɵɵNgOnChangesFeature()], ngContentSelectors: _c1, consts: 3, vars: 0, template: function InfoWindow_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵprojectionDef();
        ɵngcc0.ɵɵelementStart(0, "div", null, _c3);
        ɵngcc0.ɵɵprojection(2);
        ɵngcc0.ɵɵelementEnd();
    } }, encapsulation: 2 });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(InfoWindow, [{
        type: core.Component,
        args: [{
    ...
    }], function () { return [{ type: core.ElementRef }, { type: NguiMap }, { type: NguiMapComponent }]; }, { elementRef: [], nguiMap: [], nguiMapComponent: [], initialized$: [{
            type: core.Output
        }], objectOptions: [], inputChanges$: [], ngOnInit: [], ngOnChanges: [], initialize: [], infoWindow: [], open: [], close: [], ngOnDestroy: [], template: [{
            type: core.ViewChild,
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(CustomMarker, [{
    ...
    }], function () { return [{ type: NguiMapComponent }, { type: core.ElementRef }, { type: NguiMap }]; }, { nguiMapComponent: [], elementRef: [], nguiMap: [], initialized$: [{
            type: core.Output
        }], inputChanges$: [], ngOnInit: [], ngOnChanges: [], ngOnDestroy: [], initialize: [], el: [], mapObject: [] });
    return CustomMarker;
}());
/**
 * @nocollapse
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(Circle, [{
    ...
    }], function () { return [{ type: NguiMapComponent }]; }, { initialize: [], setCenter: [] });
    return Circle;
}(BaseMapDirective));
/**
 * @nocollapse
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(DataLayer, [{
    ...
    }], function () { return [{ type: NguiMapComponent }]; }, { initialize: [], objectOptions: [], mapObject: [] });
    return DataLayer;
}(BaseMapDirective));
/**
 * @nocollapse
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(DirectionsRenderer, [{
    ...
    }], function () { return [{ type: NguiMapComponent }, { type: NavigatorGeolocation }]; }, { initialize: [], objectOptions: [], directionsService: [], directionsRenderer: [], ngOnChanges: [], showDirections: [], ngOnDestroy: [], directionsRequest: [{
            type: core.Input,
...
GroundOverlay.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: GroundOverlay, selectors: [["ground-overlay"]], factory: function GroundOverlay_Factory(t) { return new (t || GroundOverlay)(ɵngcc0.ɵɵdirectiveInject(NguiMapComponent)); }, inputs: { url: "url", bounds: "bounds", clickable: "clickable", opacity: "opacity" }, outputs: { click: "click", dblclick: "dblclick" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(GroundOverlay, [{
        type: core.Directive,
        args: [{
...
HeatmapLayer.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: HeatmapLayer, selectors: [["heatmap-layer"]], factory: function HeatmapLayer_Factory(t) { return new (t || HeatmapLayer)(ɵngcc0.ɵɵdirectiveInject(NguiMapComponent)); }, inputs: { data: "data", dissipating: "dissipating", gradient: "gradient", maxIntensity: "maxIntensity", opacity: "opacity", radius: "radius", options: "options" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(HeatmapLayer, [{
        type: core.Directive,
        args: [{
...
KmlLayer.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: KmlLayer, selectors: [["kml-layer"]], factory: function KmlLayer_Factory(t) { return new (t || KmlLayer)(ɵngcc0.ɵɵdirectiveInject(NguiMapComponent)); }, inputs: { clickable: "clickable", preserveViewport: "preserveViewport", screenOverlays: "screenOverlays", suppressInfoWindows: "suppressInfoWindows", url: "url", zIndex: "zIndex", options: "options" }, outputs: { click: "click", defaultviewport_changed: "defaultviewport_changed", status_changed: "status_changed" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(KmlLayer, [{
        type: core.Directive,
        args: [{
...
Marker.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: Marker, selectors: [["marker"]], factory: function Marker_Factory(t) { return new (t || Marker)(ɵngcc0.ɵɵdirectiveInject(NguiMapComponent)); }, inputs: { anchorPoint: "anchorPoint", animation: "animation", clickable: "clickable", cursor: "cursor", draggable: "draggable", icon: "icon", label: "label", opacity: "opacity", optimized: "optimized", place: "place", position: "position", shape: "shape", title: "title", visible: "visible", zIndex: "zIndex", options: "options", geoFallbackPosition: "geoFallbackPosition" }, outputs: { animationChanged: "animationChanged", click: "click", clickableChanged: "clickableChanged", cursorChanged: "cursorChanged", dblclick: "dblclick", drag: "drag", dragend: "dragend", draggableChanged: "draggableChanged", dragstart: "dragstart", flatChanged: "flatChanged", iconChanged: "iconChanged", mousedown: "mousedown", mouseout: "mouseout", mouseover: "mouseover", mouseup: "mouseup", positionChanged: "positionChanged", rightclick: "rightclick", shapeChanged: "shapeChanged", titleChanged: "titleChanged", visibleChanged: "visibleChanged", zindexChanged: "zindexChanged" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(Marker, [{
        type: core.Directive,
        args: [{
    ...
    }], function () { return [{ type: NguiMapComponent }]; }, { ngOnInit: [], initialize: [], setPosition: [] });
    return Marker;
}(BaseMapDirective));
/**
 * @nocollapse
...
PlacesAutoComplete.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: PlacesAutoComplete, selectors: [["", "places-auto-complete", ""]], factory: function PlacesAutoComplete_Factory(t) { return new (t || PlacesAutoComplete)(ɵngcc0.ɵɵdirectiveInject(OptionBuilder), ɵngcc0.ɵɵdirectiveInject(core.ElementRef), ɵngcc0.ɵɵdirectiveInject(NgMapApiLoader)); }, inputs: { bounds: "bounds", componentRestrictions: "componentRestrictions", types: "types" }, outputs: { place_changed: "place_changed", initialized$: "initialized$" } });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(PlacesAutoComplete, [{
        type: core.Directive,
        args: [{
                selector: '[places-auto-complete]'
            }]
    }], function () { return [{ type: OptionBuilder }, { type: core.ElementRef }, { type: NgMapApiLoader }]; }, { optionBuilder: [], elementRef: [], apiLoader: [], place_changed: [{
            type: core.Output,
            args: ['place_changed']
        }], initialized$: [{
            type: core.Output
...
Polyline.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: Polyline, selectors: [["polyline"]], factory: function Polyline_Factory(t) { return new (t || Polyline)(ɵngcc0.ɵɵdirectiveInject(NguiMapComponent)); }, inputs: { clickable: "clickable", draggable: "draggable", editable: "editable", geodesic: "geodesic", icons: "icons", path: "path", strokeColor: "strokeColor", strokeOpacity: "strokeOpacity", strokeWeight: "strokeWeight", visible: "visible", zIndex: "zIndex", options: "options" }, outputs: { click: "click", dblclick: "dblclick", drag: "drag", dragend: "dragend", dragstart: "dragstart", mousedown: "mousedown", mousemove: "mousemove", mouseout: "mouseout", mouseover: "mouseover", mouseup: "mouseup", rightclick: "rightclick" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(Polyline, [{
        type: core.Directive,
        args: [{
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(StreetViewPanorama, [{
    ...
    }], function () { return [{ type: NguiMapComponent }]; }, { initialize: [], objectOptions: [], mapObject: [], ngOnDestroy: [] });
...
TrafficLayer.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: TrafficLayer, selectors: [["traffic-layer"]], factory: function TrafficLayer_Factory(t) { return new (t || TrafficLayer)(ɵngcc0.ɵɵdirectiveInject(NguiMapComponent)); }, inputs: { autoRefresh: "autoRefresh", options: "options" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(TrafficLayer, [{
        type: core.Directive,
        args: [{
...
TransitLayer.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: TransitLayer, selectors: [["transit-layer"]], factory: function TransitLayer_Factory(t) { return new (t || TransitLayer)(ɵngcc0.ɵɵdirectiveInject(NguiMapComponent)); }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(TransitLayer, [{
        type: core.Directive,
        args: [{
...
NguiMapModule.ngModuleDef = ɵngcc0.ɵɵdefineNgModule({ type: NguiMapModule });
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(NguiMapModule, { declarations: [NguiMapComponent,
        InfoWindow,
        Marker,
        Circle,
        CustomMarker,
        ...
        DirectionsRenderer,
        DrawingManager] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NguiMapModule, [{
        type: core.NgModule,
        args: [{
...
NguiMapModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function NguiMapModule_Factory(t) { return new (t || NguiMapModule)(); }, providers: [
        GeoCoder,
        NavigatorGeolocation,
        NguiMap,
        OptionBuilder,
