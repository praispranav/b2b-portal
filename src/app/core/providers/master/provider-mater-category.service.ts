...
export class ProviderMaterCategoryService {
  ...
  addMaterCategory(params: any = {}): Observable<any> {
    return this.http.post<any>(
      `${environment.apiUrl}/master-category/add`,
      params
    );
  }
  ...
  getMaterCategoryListByFilter(
    ...
    return this.http.get<any>(
      `${
        environment.apiUrl
      }/master-category/get-list/${index}/${length}/${JSON.stringify(query)}`
    );
  }

  updateMaterCategory(params: any = {}): Observable<any> {
    return this.http.put<any>(
      `${environment.apiUrl}/master-category/update`,
      params
    );
  }
  ...
  deleteMaterCategoryById(id: string): Observable<any> {
    return this.http.delete<any>(
      `${environment.apiUrl}/master-category/delete/${id}`
    );
  }
