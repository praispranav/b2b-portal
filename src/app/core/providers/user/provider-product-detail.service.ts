...
export class ProviderProductDetailService {
  ...
  addProductDetail(params: any = {}): Observable<any> {
    return this.http.post<any>(
      `${environment.apiUrl}/product-detail/add`,
      params
    );
  }
  ...
  getProductDetailListByFilter(
    ...
    return this.http.get<any>(
      `${
        environment.apiUrl
      }/product-detail/get-list/${index}/${length}/${JSON.stringify(query)}`
    );
  }

  updateProductDetail(params: any = {}): Observable<any> {
    return this.http.put<any>(
      `${environment.apiUrl}/product-detail/update`,
      params
    );
  }
  ...
  deleteProductDetailById(id: string): Observable<any> {
    return this.http.delete<any>(
      `${environment.apiUrl}/product-detail/delete/${id}`
    );
  }
}
