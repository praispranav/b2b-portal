...
@Component({
  selector: 'app-page-home-flash-deals',
  templateUrl: './page-home-flash-deals.component.html',
  styleUrls: ['./page-home-flash-deals.component.scss']
})
export class PageHomeFlashDealsComponent implements OnInit {
  productList: any[] = [
    {
