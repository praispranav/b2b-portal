...
@Component({
  selector: 'app-page-location-view',
  templateUrl: './page-location-view.component.html',
  styleUrls: ['./page-location-view.component.scss'],
})
export class PageLocationViewComponent implements OnInit {
  simpleNodes = [
    {
      id: 1,
