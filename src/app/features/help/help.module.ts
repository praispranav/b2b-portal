...
@NgModule({
  declarations: [PageComplainAddComponent, PageComplainListComponent, PageComplainViewComponent, PageDisputeAddComponent, PageDisputeListComponent, PageDisputeViewComponent, PageSuggestionAddComponent, PageSuggestionListComponent, PageSuggestionViewComponent],
  imports: [
    CommonModule,
    HelpRoutingModule
  ]
